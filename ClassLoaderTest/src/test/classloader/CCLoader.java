...
/**
 * Our Custom Class Loader to load the classes. Any class in the test.classloader
...
public class CCLoader extends ClassLoader {
     ...
     * test.classloader package, we will use this classloader or else delegate the
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("test.classloader")) {
